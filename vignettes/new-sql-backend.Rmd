...
This document describes how to add a new SQL backend to dplyr. While it's a work in progress, it will hopefully get you started. If you're familiar with how your database and at least one other database that dplyr supports work, this should be reasonably simple task. However, if you get stuck I'm happy to help. For example, it's possible that a new database backend may need new methods - I'm happy to add those as needed. If you need more help, please email the [mailing list](mailto:manipulatr@googlegroups.com) and I'll help you get unstuck.
