...
#' @export
#' @rdname mutate-joins
inner_join_data_frame <- function(x,
                                  y,
                                  by = NULL,
                                  copy = FALSE,
                                  suffix = c(".x", ".y"),
...
#' @export
#' @rdname mutate-joins
left_join_data_frame <- function(x,
                                 y,
                                 by = NULL,
                                 copy = FALSE,
                                 suffix = c(".x", ".y"),
...
#' @export
#' @rdname mutate-joins
right_join_data_frame <- function(x,
                                  y,
                                  by = NULL,
                                  copy = FALSE,
                                  suffix = c(".x", ".y"),
...
#' @export
#' @rdname mutate-joins
full_join_data_frame <- function(x,
                                 y,
                                 by = NULL,
                                 copy = FALSE,
                                 suffix = c(".x", ".y"),
...
#' @export
#' @rdname filter-joins
semi_join_data_frame <- function(x, y, by = NULL, copy = FALSE, ..., na_matches = c("na", "never")) {
  check_dots_empty0(...)
  y <- auto_copy(x, y, copy = copy)
...
#' @export
#' @rdname filter-joins
anti_join_data_frame <- function(x, y, by = NULL, copy = FALSE, ..., na_matches = c("na", "never")) {
  check_dots_empty0(...)
  y <- auto_copy(x, y, copy = copy)
...
#' @export
#' @rdname nest_join
nest_join_data_frame <- function(x,
                                 y,
                                 by = NULL,
                                 copy = FALSE,
                                 keep = NULL,
