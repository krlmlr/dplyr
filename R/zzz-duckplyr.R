...
meta_macro_register <- function(...) {}# end R/aaa-meta.R
...
NULL# end R/anti_join-rd.R


# end R/anti_join-rd.R
...
anti_join.data.frame <- function(x, y, by = NULL, copy = FALSE, ..., na_matches = c("na", "never")) {
  ...
  # Our implementation
  duckplyr_error <- rel_try(list(name = "anti_join", x = x, y = y, args = try_list(by = if (!is.null(by) && !is_cross_by(by)) as_join_by(by), copy = copy, na_matches = na_matches)),
...
}# end R/as_duckplyr_df.R


# end R/as_duckplyr_df.R


# begin R/as_duckplyr_tibble.R
#' as_duckplyr_tibble
#'
...
auto_copy.data.frame <- function(x, y, copy = FALSE, ...) {
  return(as_duckplyr_df_impl(as.data.frame(y)))
...
})# end R/construct_constant.R


# end R/construct_constant.R


# begin R/construct_function.R
...
})# end R/construct_function.R


# end R/construct_function.R


# begin R/construct_reference.R
...
})# end R/construct_reference.R


# end R/construct_reference.R


# begin R/construct_window.R
...
distinct.data.frame <- function(.data, ..., .keep_all = FALSE) {
  ...
  # Our implementation
  duckplyr_error <- rel_try(list(name = "distinct", x = .data, args = try_list(dots = dots, .keep_all = .keep_all)),
...
# begin R/duckdb.R
duckdb <- asNamespace("duckdb")# end R/duckdb.R


# end R/duckdb.R


# begin R/duckplyr-across.R
...
}# end R/duckplyr-across.R


# end R/duckplyr-across.R


# begin R/duckplyr_execute.R
...
NULL# end R/full_join-rd.R


# end R/full_join-rd.R
...
duckplyr_group_indices <- function(.data, ...) {
  ...
  class(out) <- setdiff(class(out), "duckplyr_df")
  out
}# end R/group_indices.R


# end R/group_indices.R


# begin R/group_keys.R
# Generated by 02-duckplyr_df-methods.R
#' @export
...
duckplyr_group_modify <- function(.data, ...) {
  ...
  class(out) <- setdiff(class(out), "duckplyr_df")
  out
}# end R/group_modify.R


# end R/group_modify.R


# begin R/group_nest.R
# Generated by 02-duckplyr_df-methods.R
#' @export
...
NULL# end R/head-rd.R


# end R/head-rd.R


# begin R/import-standalone-purrr.R
...
# nocov end# end R/import-standalone-purrr.R


# end R/import-standalone-purrr.R


# begin R/inner_join-rd.R
#' @title Inner join
#'
...
NULL# end R/inner_join-rd.R


# end R/inner_join-rd.R


# begin R/inner_join.R
# Generated by 02-duckplyr_df-methods.R
#' @rdname inner_join.duckplyr_df
#' @export
...
NULL# end R/intersect-rd.R


# end R/intersect-rd.R
...
duckplyr_the <- new_environment()# end R/last.R


# end R/last.R


# begin R/left_join-rd.R
#' @title Left join
#'
...
NULL# end R/left_join-rd.R


# end R/left_join-rd.R
...
#' - [slice()]
#' - [ungroup()]
NULL# end R/not-supported.R


# end R/not-supported.R
...
#' @export
tbl_nrow.data.frame <- function(x, ...) {
  NA_real_
}

#' @importFrom pillar tbl_format_setup
#' @export
tbl_format_setup.data.frame <- function(
  x,
  width,
  ...,
  setup,
...
exprs_project <- function(rel, exprs, .data) {
  ...
  duckplyr_reconstruct(out_rel, .data)
}# end R/project.R
...
#' @export
rel_names.relational_df <- function(rel, ...) {}# end R/relational-df.R


# end R/relational-df.R


# begin R/relational-duckdb.R
...
}# end R/relational-duckdb.R


# end R/relational-duckdb.R


# begin R/relational-expr.R
...
print.relational_relexpr <- function(x, ...) {
  utils::str(x)
  invisible(x)
}# end R/relational-expr.R


# end R/relational-expr.R


# begin R/relational-rel.R
...
rel_names <- function(rel, ...) {
  ...
  UseMethod("rel_names")
}# end R/relational-rel.R


# end R/relational-rel.R


# begin R/relational.R
...
NULL# end R/right_join-rd.R


# end R/right_join-rd.R


# begin R/right_join.R
# Generated by 02-duckplyr_df-methods.R
#' @rdname right_join.duckplyr_df
#' @export
...
NULL# end R/semi_join-rd.R


# end R/semi_join-rd.R
...
duckplyr_slice_sample <- function(.data, ...) {
  ...
  class(out) <- setdiff(class(out), "duckplyr_df")
  out
}# end R/slice_sample.R


# end R/slice_sample.R


# begin R/slice_tail.R
# Generated by 02-duckplyr_df-methods.R
#' @export
...
NULL# end R/summarise-rd.R


# end R/summarise-rd.R
...
NULL# end R/transmute-rd.R


# end R/transmute-rd.R
...
NULL# end R/union_all-rd.R


# end R/union_all-rd.R
