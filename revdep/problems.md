...
*   checking running R code from vignettes ... ERROR
    ...
    '/tmp/RtmpDg5YdA/file15b727438088/vignettes'.
    ...
    Error: Could not find a root 'DESCRIPTION' file that starts with '^Package' in
    '/tmp/Rtmpj6wRIm/file15c251eb7bcd/vignettes'.
    ℹ Are you in your project directory and does your project have a 'DESCRIPTION'
      file?
    Execution halted
    ...
    Error: Could not find a root 'DESCRIPTION' file that starts with '^Package' in
    '/tmp/Rtmp1CpkwX/file15f14a607577/vignettes'.
    ℹ Are you in your project directory and does your project have a 'DESCRIPTION'
      file?
    Execution halted
    ...
    Error: Could not find a root 'DESCRIPTION' file that starts with '^Package' in
    '/tmp/RtmpczBcpK/file15fc7bd8b652/vignettes'.
    ℹ Are you in your project directory and does your project have a 'DESCRIPTION'
      file?
    Execution halted
