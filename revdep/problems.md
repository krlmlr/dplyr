...
*   checking tests ... ERROR
    ...
    Complete output:
      ...
      [ FAIL 4 | WARN 0 | SKIP 355 | PASS 1404 ]
      ...
      • {RSQLite} is not installed (2): 'test-count-tally.R:86:3',
      ...
      `actual$default_duckdb_connection$con@conn_ref` is <pointer: 0x5652f6e84c70>
      `expected$default_duckdb_connection$con@conn_ref` is <pointer: 0x5652f923a900>
      
      `actual$default_duckdb_connection$con@driver@database_ref` is <pointer: 0x5652f5fb4b90>
      `expected$default_duckdb_connection$con@driver@database_ref` is <pointer: 0x5652f923bad0>
      
      `environment(actual$df_from_csv)` is <env:namespace:duckplyr>
      `environment(expected$df_from_csv)` is <env:namespace:dplyr>
      
      body(actual$df_from_file)[1:6] vs body(expected$df_from_file)[1:6]
        `{`
        `    check_dots_empty()`
      ...
      `expected$rel_stats_env$rel_names`: 170
      ...
      `expected$rel_stats_env$rel_to_df`: 554
      ...
      body(actual$rel_translate)[16:22] vs body(expected$rel_translate)[16:22]
      ...
      body(actual$rel_translate)[27:33] vs body(expected$rel_translate)[27:33]
        `                  relexpr_constant(val)`
        `                }`
        `            }, language = rel_translate_lang(expr, do_translate, `
      - `                names_data, env, partition, in_window, need_window), `
      + `                data, env, partition, in_window, need_window), `
        `            cli::cli_abort("Internal: Unknown type {.val {typeof(expr)}}"))`
        `    }`
        `    out <- do_translate(expr, top_level = TRUE)`
      
      `formals(actual$rel_translate)` is length 7
      `formals(expected$rel_translate)` is length 6
      
      names(formals(actual$rel_translate))[3:7] vs names(formals(expected$rel_translate))[3:6]
        "alias"
        "partition"
        "need_window"
      - "names_data"
      ...
      `formals(actual$rel_translate)$names_data` is a call
      `formals(expected$rel_translate)$names_data` is absent
      ...
      body(actual$rel_translate_lang)[2:7] vs body(expected$rel_translate_lang)[2:17]
        `{`
      ...
      + `    if (name %in% c(">", "<", "==", ">=", "<=")) {`
      + `        if (length(expr) != 3) `
      + `            cli::cli_abort("Expected three expressions for comparison. Got {length(expr)}")`
      ...
      + `            return(relexpr_comparison(name, list(do_translate(expr[[2]]), `
      and 6 more ...
      
      body(actual$rel_translate_lang)[32:38] vs body(expected$rel_translate_lang)[42:48]
        `            cli::cli_abort("{name}({names(args)[which(bad)[[1]]]} = ) not supported")`
        `        }`
        `    }, \`%in%\` = {`
      - `        values <- eval_tidy(expr[[3]], data = new_failing_mask(names_data), `
      + `        values <- eval_tidy(expr[[3]], data = new_failing_mask(names(data)), `
        `            env = env)`
        `        if (length(values) == 0) {`
        `            return(relexpr_constant(FALSE))`
      
      body(actual$rel_translate_lang)[47:52] vs body(expected$rel_translate_lang)[57:65]
        `            }`
        `        } else {`
        `            has_na <- FALSE`
        `        }`
      ...
      body(actual$rel_translate_lang)[71:77] vs body(expected$rel_translate_lang)[84:92]
        `    })`
      ...
      names(formals(actual$rel_translate_lang))[1:6] vs names(formals(expected$rel_translate_lang))[1:6]
        "expr"
        "do_translate"
      - "names_data"
      + "data"
      ...
      body(actual$to_duckdb_expr)[5:10] vs body(expected$to_duckdb_expr)[5:16]
        `        if (!is.null(x$alias)) {`
      ...
      body(actual$to_duckdb_expr_meta)[13:18] vs body(expected$to_duckdb_expr_meta)[13:28]
        `                tmp_expr`
        `            })`
        `        }`
        `        out`
...
* Version: 0.8.0
* GitHub: NA
* Source code: https://github.com/cran/GHCNr
* Date/Publication: 2024-12-13 16:40:17 UTC
* Number of recursive dependencies: 71

Run `revdepcheck::cloud_details(, "GHCNr")` for more info
...
*   checking re-building of vignette outputs ... ERROR
    ...
    --- re-building ‘daily.Rmd’ using rmarkdown
    ```
...
*   checking tests ... ERROR
    ...
    Complete output:
      ...
      > 
      > test_check("mtdesign")
      testthat 2024-12-14 14:24:49 DEBUG test_check: Entry
      testthat 2024-12-14 14:24:49 DEBUG test_check: Entry
      testthat 2024-12-14 14:24:49 DEBUG test_check: Exit
      testthat 2024-12-14 14:24:49 DEBUG test_check: One stage sample size is 15.  Search bounds are 20 to 30.
      testthat 2024-12-14 14:24:49 TRACE test_check: Building grid - nTotal, nStage1: 264
      testthat 2024-12-14 14:24:49 TRACE test_check: Building grid - nTotal, nStage1, rTotal: 6710
      testthat 2024-12-14 14:24:49 TRACE test_check: Building grid - nTotal, nStage1, rTotal, rFutility: 26620
      testthat 2024-12-14 14:24:49 TRACE test_check: Building grid - nTotal, nStage1, rTotal, rFutility, rSuccess: 97571
      testthat 2024-12-14 14:24:49 TRACE test_check: Grid has 97571 rows.
      testthat 2024-12-14 14:24:49 DEBUG test_check: Exit
      testthat 2024-12-14 14:24:49 DEBUG test_check: Entry
      testthat 2024-12-14 14:24:49 DEBUG test_check: Entry
      testthat 2024-12-14 14:24:49 DEBUG test_check: Exit
      ...
      testthat 2024-12-14 14:24:49 DEBUG test_check: Exit
      testthat 2024-12-14 14:24:49 DEBUG test_check: Exit
      testthat 2024-12-14 14:24:50 DEBUG test_check: Entry
      testthat 2024-12-14 14:24:50 DEBUG test_check: Entry
      testthat 2024-12-14 14:24:50 DEBUG test_check: Exit
      testthat 2024-12-14 14:24:50 DEBUG test_check: Exit
      testthat 2024-12-14 14:24:50 DEBUG test_check: Entry
      testthat 2024-12-14 14:24:50 DEBUG test_check: Entry
      testthat 2024-12-14 14:24:50 DEBUG test_check: Exit
...
* Version: 1.5.3
* GitHub: https://github.com/nandp1/nser
* Source code: https://github.com/cran/nser
* Date/Publication: 2024-07-26 09:20:01 UTC
* Number of recursive dependencies: 83

Run `revdepcheck::cloud_details(, "nser")` for more info
...
*   checking examples ... ERROR
    ...
    Warning in download.file(bhavurl, temp) :
      downloaded length 67560 != reported length 593613
    Warning in download.file(bhavurl, temp) :
...
* Date/Publication: 2024-02-12 00:40:02 UTC
* Number of recursive dependencies: 33

Run `revdepcheck::cloud_details(, "rollmatch")` for more info
