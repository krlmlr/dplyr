...
error: package `prqlr v0.13.1 (/tmp/workdir/prqlr/new/prqlr.Rcheck/00_pkg_src/prqlr/src/rust)` cannot be built because it requires rustc 1.81.0 or newer, while the currently active rustc version is 1.75.0
